...
## 3. Steven Johnson's "Interesting Bits"
```
...
```
"A quiz show with two hosts.
First host quizzes the second on [TOPIC]. 10 questions total. Mix of multiple choice and True/False.
