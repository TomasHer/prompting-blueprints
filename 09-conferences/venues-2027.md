...
| To be announced | **ISD 2027** | Not yet announced | PC member on the LASD track in 2025 and 2026 |
...
- **RE 2027 in Milan** is the natural follow-up venue for the industrial RE work — the
  [requirements engineering blueprints](../08-requirements-engineering/overview.md) map to its
  industry tracks.
- **REFSQ 2027's theme** is requirements engineering under AI-accelerated development: how RE
  processes, tools and practices keep pace with faster implementation while staying aligned with
  stakeholder needs.

## Verification status

Dates and venues below were collected in September 2026 from conference series pages and event
...
- [Author's Speaking & Keynotes](../01-about-author/speaking/index.md)
- [Program Committee & Track Leadership Overview](../01-about-author/program-committee/index.md)
- [GAISE 2026 — Conference Notes](gaise-2026.md)
- [Conference Notes — Template](conference-template.md)
