...
## References
- Cobus Greyling — [The Evolving Vocabulary of AI](https://cobusgreyling.medium.com/the-evolving-vocabulary-of-ai-2ea12100811d) (traces AI vocabulary through six phases and frames the convergence as a single engineering stack — context → harness → loop → fleet engineering; the parallel framing to this page's generations, extended one layer further into [Agent Fleet Governance](agent-fleet-governance.md))
