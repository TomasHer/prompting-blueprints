...
## Unreleased
- Detail retrieval, task, and autonomous agent tiers with supporting diagram and Microsoft custom retrieval agent reference in the AI agents overview guide.
