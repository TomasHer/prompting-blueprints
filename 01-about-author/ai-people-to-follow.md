...
| **Andrew Ng** _(curated)_ | AI education at scale; DeepLearning.AI short courses; *The Batch* newsletter | [DeepLearning.AI](https://www.deeplearning.ai/) | DeepLearning.AI Claude Code course (cited in tooling guides); the three nested loops in [Loop Engineering](../02-ai-agents/01-foundations/loop-engineering.md); the [AI Engineering Skills Map](../04-guides/ai-engineering-skills-map.md); OpenWorker in [OpenWorker Security Coworkers](../05-tools/openworker-security-tutorial.md) |
